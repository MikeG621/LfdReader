...
namespace Idmr.LfdReader
{
	...
	/// }</code>
	/// <para>The order of the Blocks is usually VIEW, VOIC, PLTT, ANIM/DELT/CUST.
	/// Within the Blocks themselves, if it's to be used then the first Chunk will be a Time code, otherwise it will skip directly to the End.</para></example>
	public class Film : Resource
	{
		...
		/// <param name="filePosition">The offset of the beginning of the resourc.e</param>
