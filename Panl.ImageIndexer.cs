...
namespace Idmr.LfdReader
{
	public partial class Panl : Resource
	{
		...
		public class ImageIndexer : IEnumerable<Bitmap>
		{
			...
			public Bitmap this[int index]
			{
				...
				set
				{
					...
					try
					{
						_items[index] = GraphicsFunctions.ConvertTo8bpp(value, _parent._palette);
						_parent.Dirty();
					}
			...
			public void SetPalette(ColorPalette palette)
			{
				...
				for (int i = 0; i < _items.Count; i++) _items[i].Palette = palette;
			}
